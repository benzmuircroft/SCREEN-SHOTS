...
<div class="main"style="z-index:9;position:relative;height:320px;width:480px;margin-left:auto;margin-right:auto;text-align:center;margin-top:0px;background:#000;color:#999;font-family:'gisha';text-align:left;display:none;">
	<div style="margin-top:10px;">
		...
		<div style="float:right;margin-right:4px;">quickreport.it </div>
	</div>
	<br>
	<a style="color:#FFF;float:right;font-size:10px;margin-right: 4px;" href="http://quickreport.it/R/phuket/legal/terms.txt" target="_blank">Terms Of Service</a>
...
var s={}, S={}, data={'nickname':nickname};$.getScript('c.REWIRE.js',function(){connect('engine.quickreport.it',[1],[8007],data,'C.qrit_a_.js');});
