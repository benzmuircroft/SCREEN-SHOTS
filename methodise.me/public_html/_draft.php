...
<html lang="en">
    ...
    <body style="font-family:arial,NotoColorEmoji;overflow:hidden;"id="body">
        ...
        <div id="white_rabbit" class="protect_img_black app" style="display:none;width:427px;height:10px;padding:5px;position:fixed;top:calc(100% - 334px);left:calc(50% - 221px);z-index:6;">
            ...
            <div id="white_rabbit_cc2u" class="white_rabbit_content" style="font-size:10px;font-weight:bold;overflow:auto;outline:none;width:427px;height:223px;position:absolute;top:20px;left:0px;background:#03a0f5;padding:5px;color:#fff;">
                <div id="cc2u" style="position:relative;background:#000;font-weight:normal;height:130px;width:427px;margin-bottom:5px;overflow-y:scroll;" class="tip" tip="Pick a page that your rabbit hole will lead to">
                ...
                <div style="background:#03a0f5;position:absolute;width:427px;height:4px;top:135px;"></div>
            ...
            <div id="white_rabbit_u2cc" class="white_rabbit_content" style="font-size:10px;font-weight:bold;overflow:auto;outline:none;width:427px;height:223px;position:absolute;top:20px;left:0px;background:#03a0f5;padding:5px;color:#fff;">
                <div id="u2cc" style="position:relative;background:#000;font-weight:normal;height:130px;width:427px;margin-bottom:5px;overflow-y:scroll;" class="tip" tip="Pick a page that your rabbit hole will lead to">
